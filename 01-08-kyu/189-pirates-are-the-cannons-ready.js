...
const cannonsReady = (gunners) => Object.values(gunners).indexOf('nay') === -1 ? 'Fire!' : 'Shiver me timbers!';

---------------------

const cannonsReady = gunners => Object.values(gunners).some(el => el === 'nay') ? 'Shiver me timbers!' : 'Fire!';
